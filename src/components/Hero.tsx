...
export default function Hero() {
  return (
    <div className="text-white relative z-50 px-5 mb-40">
      <div className="text-white text-center text-4xl font-semibold mt-20">World War Meme</div>
      <div className="text-center mt-5 text-lg text-white/70">World War Meme is an innovative and entertaining memecoin project that blends the world of cryptocurrency with the captivating culture of internet memes.</div>
      <div className="text-2xl font-medium mt-10 text-center">Why World War Meme?</div>
      <div className="text-left mt-4 text-lg text-white/50 px-5">
