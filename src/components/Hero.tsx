    ...
    <div className="text-white relative z-50 px-5 mb-40">
      ...
      <div className="text-left mt-4  text-white/50">
        <ul className=" list-none">
          <li className="mb-5 p-4 rounded-xl bg-gradient-to-tr from-white/5 to-[#ffffff07] backdrop-blur-sm border border-white/10">
            <div>
          ...
          <li className="mb-5 p-4 rounded-xl bg-gradient-to-tr from-white/5 to-[#ffffff07] backdrop-blur-sm border border border-white/10">
            <div>
