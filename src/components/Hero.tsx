...
export default function Hero() {
  return (
    <div>
      <div className="text-white relative z-50 px-5">
        ...
        <div className="text-left mt-4  text-white/50">
          <ul className=" list-none">
            <li className="mb-5 p-4 rounded-3xl bg-gradient-to-tr from-white/5 to-[#ffffff07] backdrop-blur-sm border border-white/10">
              <div>
            ...
            <li className="mb-5 p-4 rounded-3xl bg-gradient-to-tr from-white/5 to-[#ffffff07] backdrop-blur-sm border border border-white/10">
              <div>
        ...
        <div id="tokenomics" className="text-center mt-20 font-semibold text-4xl">
          Tokenomics
        </div>
        <div className="text-center mt-5 text-white/50">CA : Announced soon.</div>
        <div className="mt-5">
          <ul className=" list-disc px-5 leading-10">
            <li>
              Supply = <span className="text-white/70">1,000,000,000 WWM</span>
            </li>
            <li>
              Add to Liquidity = <span className="text-white/70">1,000,000,000 WWM</span>
            </li>
            <li>
              Buy Tax = <span className="text-white/70">0%</span>
            </li>
            <li>
              Sell Tax = <span className="text-white/70">0%</span>
            </li>
            <li>
              Liquidity burn <span className="text-white/70">on $10k MCAP</span>
            </li>
          </ul>
        </div>
        <div>
          <div id="roadmap" className="h-full ">
            <div className=" text-center mt-20 font-semibold text-4xl mb-10">Roadmap</div>
            <div className="grid md:grid-rows-4 gap-5">
              <div className="bg-[#ff8133] pl-1 rounded-[26px]">
                <div id="master" className="grid md:grid-cols-2  w-full h-full bg-[#111] py-5 px-10 rounded-3xl ">
                  <div className="md:items-center flex">
                    <div>
                      <p className="md:text-6xl text-2xl  font-semibold  text-white  ">August 2024</p>
                      <p className="text-white/50 text-sm md:mb-0 mb-5">Project Announcement and Initial Community Building</p>
                    </div>
                  </div>
                  <div className="md:items-center items-start h-full flex">
                    <div className="z-50">
                      <p className="flex items-center font-extralight mt-0">
                        <span className="flex h-1.5 w-1.5 bg-white rounded-full mr-2"></span>Build World War Meme
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#5bea8f" className="size-6 ml-2">
                          <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                        </svg>
                      </p>
                      <p className="flex items-center font-extralight mt-2">
                        <span className="flex h-1.5 w-1.5 bg-white rounded-full mr-2"></span>Social Media Launch
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#5bea8f" className="size-6 ml-2">
                          <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                        </svg>
                      </p>
                      <p className="flex items-center font-extralight mt-2">
                        <span className="flex h-1.5 w-1.5 bg-white rounded-full mr-2"></span>Website Launch
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#5bea8f" className="size-6 ml-2">
                          <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                        </svg>
                      </p>
                      <p className="flex items-center font-extralight mt-2">
                        <span className="flex h-1.5 w-1.5 bg-white rounded-full mr-2"></span>Token Launch
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#5bea8f" className="size-6 ml-2">
                          <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                        </svg>
                      </p>
              ...
              <div className="bg-[#ff8133] rounded-[26px]">
                <div id="master" className="grid md:grid-cols-2  w-full h-full bg-[#111] py-5 px-10 rounded-3xl relative ">
                  <div className="md:items-center flex">
                    <div>
                      <p className="md:text-6xl text-2xl  font-semibold  text-white/70  ">Q3 2024</p>
                      <p className="text-white/50 text-sm md:mb-0 mb-5">Beta Launch and Initial Gameplay Testing</p>
                    </div>
                  </div>
                  <div className="items-center h-full flex">
                    <div className="z-50 text-shadow">
                      <p className="flex items-center text-white/50 font-extralight mt-0">
                        <span className="flex h-1.5 w-1.5 bg-white/50  rounded-full mr-2"></span>WWM Tap-tap game
                      </p>
                      <p className="flex items-center font-extralight mt-2 text-white/50">
                        <span className="flex h-1.5 w-1.5 bg-white/50 rounded-full mr-2"></span>Convert points to WWM Token.
                      </p>
                      <p className="flex items-center font-extralight mt-2 text-white/50">
                        <span className="flex h-1.5 w-1.5 bg-white/50 rounded-full mr-2"></span>NFT WWM Whitelist.
                      </p>
                      <p className="flex items-center font-extralight mt-2 text-white/50">
                        <span className="flex h-1.5 w-1.5 bg-white/50 rounded-full mr-2"></span>NFT WWM distribution.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div id="master" className="grid md:grid-cols-2  w-full h-full bg-[#111] py-5 px-10 rounded-3xl ">
                <div className="md:items-center flex">
                  <div>
                    <p className="md:text-6xl text-2xl  font-semibold  text-white/70  ">Q4 2024</p>
                    <p className="text-white/50 text-sm md:mb-0 mb-5">Full Game Launch and NFT Integration</p>
                  </div>
                </div>
                <div className="items-center h-full flex">
                  <div className="">
                    <p className="flex items-center font-extralight mt-0 text-white/50">
                      <span className="flex h-1.5 w-1.5 bg-white/50 rounded-full mr-2 "></span>NFT Game.
                    </p>
                    <p className="flex items-center font-extralight mt-2 text-white/50">
                      <span className="flex h-1.5 w-1.5 bg-white/50 rounded-full mr-2"></span>Convertion points to WWM tokens
                    </p>
                    <p className="flex items-center font-extralight mt-2 text-white/50">
                      <span className="flex h-1.5 w-1.5 bg-white/50 rounded-full mr-2"></span>Marketplace
                    </p>
                  </div>
                </div>
              </div>
              <div id="master" className="grid md:grid-cols-2  w-full h-full bg-[#111] py-5 px-10 rounded-3xl ">
                <div className="md:items-center flex">
                  <div>
                    <p className="md:text-6xl text-2xl  font-semibold  text-white/70  ">Q1 2025</p>
                    <p className="text-white/50 text-sm md:mb-0 mb-5">Marketing and Airdrops</p>
                  </div>
                </div>
                <div className="items-center h-full flex">
                  <div className="">
                    <p className="flex items-center font-extralight mt-0 text-white/50">
                      <span className="flex h-1.5 w-1.5 bg-white/50 rounded-full mr-2"></span>Airdrop Campaign
                    </p>
                    <p className="flex items-center font-extralight mt-2 text-white/50">
                      <span className="flex h-1.5 w-1.5 bg-white/50 rounded-full mr-2"></span>Referral Reward
                    </p>
                    <p className="flex items-center font-extralight mt-2 text-white/50">
                      <span className="flex h-1.5 w-1.5 bg-white/50 rounded-full mr-2"></span>Marketing expansion
                    </p>
                    <p className="flex items-center font-extralight mt-2 text-white/50">
                      <span className="flex h-1.5 w-1.5 bg-white/50 rounded-full mr-2"></span>CEX Listing
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="relative z-50 ">
        <img src={army} alt="army" className=""></img>
        <div className="text-5xl -mt-40 font-bold uppercase text-center h-40 flex mx-auto justify-center items-end bg-gradient-to-t from-[#000] to-[#00000000] via-[#000000a0] relative text-white">Join us now !</div>
        <div className="flex gap-5 justify-center bg-black pt-5">
          <a href="https://t.me/wwm_portal">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256" className="h-8 w-auto">
              <g fill="#ffffff">
        ...
        <div className="text-white/50 h-20 bg-black w-full flex justify-center items-end pb-2 pt-40">© 2024 World War Meme | All Rights Reserved.</div>
      </div>
    </div>
  );
}
